...
public class ConstValues {
    ...
    public static final String LISTURL = "http://www.wanandroid.com/banner/json";
    public static final String SERVICE_PUHONENUM = "";

    /**
     * 服务器后台地址
     */
    public static final String BASE_BASE_URL = "http://yjsd.yunjisudai.com:8080/yjsdmanage/";
    ...
    //极验
    public static final String STARTCAPTCHA_URL = "http://yjsd.yunjisudai.com:8080/yjsdmanage/api/init";
    public static final String SENDVERIFY_URL = "http://yjsd.yunjisudai.com:8080/yjsdmanage/api/init1";
    /**
     * 登录界面图形验证码获取url
     */
    ...
    //bugly app key
    public static final String BUGLY_KEY = "c87eea9acd";
    //白骑士 密钥
    ...
    //魔蝎 apikey
    public static final String MOXIE_API_KEY ="71730b62e1404aab94c1ceadd8d01f12";
    //连连还款回调
    ...
    public static final String YOUDUN_AUTHKEY = "f2bd1f2e-b8cf-4515-ad5f-cd4b83c0a2b7";
    //有盾异步通知接口地址(非必传)
    public static final String YOUDUN_URLNOTIFY = null;
    //富友支付key
    public static final String FUYOU_KEY = "k7gtuo0tdsj9ys926bwvhsohhkaccrvc";
    //富友支付商户号
    public static final String FUYOU_ID = "0003320F1688205";
    //富有还款回调
    ...
    //fir.im id
    public static final String FIR_ID = "5b62b4ddca87a82f574bc34c";
    //fir.im apitoken
    public static final String FIR_API_TOKEN = "7a36261251ceafe8188e7e1e8c268570";
}
